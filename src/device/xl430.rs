...
reg_read_write!(homing_offset, 20, u32);
...
reg_read_write!(feed_forward_gain_2, 88, u16);
reg_read_write!(feed_forward_gain_1, 90, u16);
...
reg_read_only!(present_current, 128, u16);
