...
use rustypot::device::orbita2d_poulpe::MotorPositionSpeedLoad;
...
fn main() -> Result<(), Box<dyn Error>> {
	...
	match feedback {
	    Ok(feedback) => {
		nbok+=1;
		println!("42 target: {} feedback pos: {} {} {} feedback vel: {} {} {} feedback torque: {} {} {} ", target, feedback.position.top,feedback.position.middle,feedback.position.bottom,feedback.speed.top,feedback.speed.middle,feedback.speed.bottom,feedback.load.top,feedback.load.middle,feedback.load.bottom);
			    },
	    Err(e) => {
		nberr+=1;
		println!("error: {:?}", e);
    ...
    println!("nberr: {} nbtot: {} nbok: {} ratio: {:?}",nberr,nbtot,nbok, nbok as f32 / nbtot as f32);
